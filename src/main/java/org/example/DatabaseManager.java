...
public class DatabaseManager {
    ...
    public static void insertData(List<ExcelDataModel> data) {
    ...
    public static void top3Panels() {
        try (Connection connection = dataSource.getConnection();
            ...
            PdfGenerator.createPanelPdf(dataset,"C:\\Users\\sharma.aayushi\\Downloads\\chart\\ExcelFileReader\\src\\main\\java\\org\\example\\Top3Panel.pdf");
    ...
    public static void top3Skills() {
        try (Connection connection = dataSource.getConnection();
            ...
            PdfGenerator.createSkillsPdf(dataset,"C:\\Users\\sharma.aayushi\\Downloads\\chart\\ExcelFileReader\\src\\main\\java\\org\\example\\Top3Skills.pdf");
